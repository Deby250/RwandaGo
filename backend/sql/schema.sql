-- ========================================
-- RWANDAGO DATABASE SCHEMA (MySQL)
-- ========================================

-- Create database
CREATE DATABASE IF NOT EXISTS rwandago;
USE rwandago;
...
INSERT INTO users (first_name, last_name, email, password, phone, role, is_verified) VALUES 
('Admin', 'User', 'admin@rwandago.com', '$2a$10$rQvGZqGqGqGqGqGqGqGqGq', '+250788123457', 'admin', TRUE),
('Support', 'Agent', 'support@rwandago.com', '$2a$10$rQvGZqGqGqGqGqGqGqGqGq', '+250788123458', 'support', TRUE),
('Driver', 'Guide', 'driver@rwandago.com', '$2a$10$rQvGZqGqGqGqGqGqGqGqGq', '+250788123459', 'driver', TRUE);